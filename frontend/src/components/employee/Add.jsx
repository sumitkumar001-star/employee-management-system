        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
          ...
          <div className="md:col-span-1">
            ...
            <input
              ...
              onChange={handleChange}
              accept="image/*"
              className="block w-full text-xs sm:text-sm text-gray-500 file:mr-2 sm:file:mr-4 file:py-2 file:px-3 sm:file:px-4 file:rounded-lg file:border-0 file:font-semibold file:bg-teal-100 file:text-teal-700 hover:file:bg-teal-200 transition-colors duration-200 cursor-pointer"
              required
            />
          </div>
          <div className="md:col-span-2 mt-4">
            <button
              type="submit"
              className="w-full flex justify-center py-2.5 sm:py-3 px-4 border border-transparent rounded-md shadow-sm text-sm sm:text-base font-bold text-white bg-teal-600 hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500 transition-all duration-200"
            >
              Add Employee
            </button>
          </div>
